...
t0 = Tile(00,-200,3,htile(225,-225,"dark magenta","$200")) 
...
dd= {
    ...
    31:t31,32:t32,33:t33,34:t34,35:t35,36:t36,37:t37,38:t38,39:t39
}
...
while p1_cash >=0 and p2_cash>= 0:
    ...
    #Player 1 Movement
    wn = turtle.Screen()
    answer = wn.textinput("Next Roll", "Press OK to roll the dice, Cancel to quit:")
    ...
    if dd[cp1].o == 0:
        y_n = wn.textinput("Purchase?","Type Y to purchase")
    ...
    print("p1_cash = " + str(p1_cash))
    print("p2_cash = " + str(p2_cash))
    print("-----------")
